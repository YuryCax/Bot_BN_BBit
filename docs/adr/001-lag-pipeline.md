...
> **Historical only.** ADR-003 moves lag + entry to Singapore with a Tokyo raw-tick forwarder. Keep this ADR for audit of v2.3 deployments and replay of `packet_version = 3` logs that used reverse Bybit mid on Observer.
